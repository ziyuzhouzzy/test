...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set o_RX_DV_0 [ create_bd_port -dir O -from 2 -to 0 o_RX_DV_0 ]
  ...
  # Create instance: uart_top_led_0, and set properties
  set block_name uart_top_led
  set block_cell_name uart_top_led_0
  if { [catch {set uart_top_led_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $uart_top_led_0 eq "" } {
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins uart_top_led_0/i_Clk]
  connect_bd_net -net processing_system7_0_UART1_TX [get_bd_pins processing_system7_0/UART1_TX] [get_bd_pins uart_top_led_0/i_RX_Serial]
  connect_bd_net -net uart_top_led_0_o_RX_DV [get_bd_ports o_RX_DV_0] [get_bd_pins uart_top_led_0/led]
  connect_bd_net -net uart_top_led_0_o_TX_Serial [get_bd_pins processing_system7_0/UART1_RX] [get_bd_pins uart_top_led_0/o_TX_Serial]
